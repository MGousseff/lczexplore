...
"/lczfiles/Redon"), file="osm_lcz.fgb",column="LCZ_PRIMARY",output="bBox")
...
dirPathOSM<-paste0(dirPath,"lczfiles/Redon/")
...
```{r, sidney 1, echo=TRUE, fig.show="hide"}
...
dirPath = system.file("extdata/lczfiles/Sidney/", package = "lczexplore"), file="sidney_rsu_lcz.fgb",
column="LCZ_PRIMARY",
...
```{r, sensib plot, out.width = "680px"}
path1<-system.file("extdata/vignettes/", package = "lczexplore")
...
```{r, out.width = "680px"}
path2<-system.file("extdata/vignettes/", package = "lczexplore")
