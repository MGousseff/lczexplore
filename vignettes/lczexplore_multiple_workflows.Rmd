...
Stewardt and Oke have proposed a classification of Local Climate Zones (LCZ)
that describe rural and urban areas, with 10 built types and 7 land cover types.
Several workflows allow to produce LCZ maps, and none can be considered as
an absolute reference. Therefore, there is a need for comparison of maps produced by different workflows.

This vignette shows how to compare 3 workflows (i.e. their resulting maps) at a time and the process can be extended
